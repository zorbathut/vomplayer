...
src/
  ...
  ViewModels/
    ViewModelMain.cs       # coordinator: owns Primary VideoContext (always), optional Secondary (PiP); routes transport (selected ⇒ isolated; null ⇒ broadcast/sync); sync-mode stored targetOffset (absolute-pin seeks) + post-edge correction; lockstep advance gate
